...
export default function SearchComponentHOC(Component){
  return class extends React.Component{
    render() {
      const {globalFetching,globalSearch,onChangeHandle,onSearchHandle,controlledValue,toggleGlobalSearch,...otherProps}=this.props
          ...
          <Search
            addonBefore={
              ...
              <Badge count={"?"}
                     ...
                     style={styles.badge}/>
              <Component style={styles.slideCheckBox}
                         checkedChildren={
                           <span>
                             全局
