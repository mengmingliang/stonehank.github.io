...
import SearchComponentHOC from "./SearchComponentHOC";
...
export default class SearchContainerBeat extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      controlledValue: '',
  ...
  computeArticleMatch(patternValue) {
    ...
    for (let index = 0; index < data.length; index++) {
      ...
      let precisionMatchArr=Array(simpleSearchProps.length+complicateSearchProps.length).fill(0)
      let weightPoint=0
